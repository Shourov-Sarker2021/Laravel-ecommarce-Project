        ...
        <div class="col-lg-7 mb-4 mb-lg-0">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control h-auto py-2" name="firstName" required />
                </div>
                <div class="form-group col-md-6">
                    <label class="form-label">Last Name <span class="text-color-danger">*</span></label>
                    <input type="text" class="form-control h-auto py-2" name="lastName" required />
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-4">
                    ...
                    <div class="custom-select-1">
                        <select class="form-select form-control h-auto py-2" name="country" required>
                            ...
                            <option value="5">United Kingdon</option>
                        </select>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label class="form-label">District/State <span class="text-color-danger">*</span></label>
                    <div class="custom-select-1">
                        <select class="form-select form-control h-auto py-2" name="district" required>
                            <option value="" selected></option>
                ...
                <div class="form-group col-md-4">
                    <label class="form-label">Thana/Town/City <span class="text-color-danger">*</span></label>
                    <select class="form-select form-control h-auto py-2" name="thana" required>
                        <option value="" selected></option>
                        <option value="1">Dhaka</option>
                        <option value="2">Savar</option>
                        <option value="3">Tongi</option>
            ...
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control h-auto py-2" name="address" placeholder="House number and street name" required />
                </div>
            </div>
            <div class="row">
                <div class="form-group col">
